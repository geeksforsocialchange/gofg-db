...
ActiveRecord::Schema.define(version: 20170917203523) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "activity_coaches", id: :serial, force: :cascade do |t|
    t.integer "event_id"
    t.integer "person_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_id"], name: "index_activity_coaches_on_event_id"
    t.index ["person_id"], name: "index_activity_coaches_on_person_id"
  end
  ...
  create_table "documents_events", id: :serial, force: :cascade do |t|
    t.integer "document_id"
    t.integer "event_id"
    t.index ["document_id"], name: "index_documents_events_on_document_id"
    t.index ["event_id"], name: "index_documents_events_on_event_id"
  end

  create_table "documents_people", id: :serial, force: :cascade do |t|
    t.integer "document_id"
    t.integer "person_id"
  ...
  create_table "questionnaires", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["import_id"], name: "index_questionnaires_on_import_id"
    t.index ["person_id"], name: "index_questionnaires_on_person_id"
  end
